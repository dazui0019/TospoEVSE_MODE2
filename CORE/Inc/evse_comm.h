...
#define UI_CMD_UPDATE_ALL       0    // 更新所有数据
#define UI_CMD_UPDATE_VOLTAGE   1    // 更新电压
#define UI_CMD_UPDATE_CURRENT   2    // 更新电流
#define UI_CMD_UPDATE_POWER     3    // 更新功率
#define UI_CMD_UPDATE_KWH       4    // 更新电量
#define UI_CMD_UPDATE_ERR       5    // 更新错误信息
#define UI_CMD_UPDATE_CNN_STATE 6    // 更新枪线和汽车的连接状态
#define UI_CMD_UPDATE_DELAY     7    // 更新延迟上电时间
#define UI_CMD_UPDATE_CHG_STATE 8    // 更新充电状态
