...
#define  RCD_TEST_GPIO_PIN    GPIO_PIN_14
...
#define  RCD_ZERO_GPIO_PIN    GPIO_PIN_12
...
//RMS_CAL     校有效值信号 
#define  RCD_RMS_PORT        GPIOB 
#define  RCD_RMS_GPIO_PIN    GPIO_PIN_2
#define  RCD_RMS_GPIO_CLK    RCU_GPIOB

#define  RCD_RMS_OPEN()      gpio_bit_set(RCD_RMS_PORT,RCD_RMS_GPIO_PIN)        //打开RCD校准模式
#define  RCD_RMS_CLOSE()     gpio_bit_reset(RCD_RMS_PORT,RCD_RMS_GPIO_PIN)      //关闭RCD校准模式

/*RCD_TRIP   RCD */
#define RCD_TRIP_PIN                   GPIO_PIN_13
#define RCD_TRIP_GPIO_PORT             GPIOB
#define RCD_TRIP_GPIO_CLK              RCU_GPIOB

#define RCD_TRIP_EXTI_LINE             EXTI_13
#define RCD_TRIP_EXTI_PORT_SOURCE      GPIO_PORT_SOURCE_GPIOB
#define RCD_TRIP_EXTI_PIN_SOURCE       GPIO_PIN_SOURCE_13
#define RCD_TRIP_EXTI_IRQn             EXTI10_15_IRQn  
